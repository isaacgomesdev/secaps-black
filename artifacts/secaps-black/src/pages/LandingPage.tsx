...
export default function LandingPage() {
  return (
    <div className="gradient-bg min-h-screen text-white">
      ...
      {/* HERO */}
      <section className="hero-gradient pt-24 pb-16 px-4 text-center relative overflow-hidden">
        <div className="absolute inset-0 pointer-events-none">
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] rounded-full bg-[#00ddb4]/5 blur-3xl"></div>
        </div>
        <div className="max-w-4xl mx-auto relative z-10">
          ...
          <p className="text-xl md:text-2xl text-gray-300 mb-4 font-light max-w-2xl mx-auto">
            A fórmula 10x mais potente que está transformando a vida de <strong className="text-white">+100.000 brasileiros</strong>
          </p>
          <div className="flex items-center justify-center gap-2 mb-8">
            {[1,2,3,4].map(i => (
              <span key={i} className="star-gold text-2xl">★</span>
            ))}
          ...
          <div className="relative inline-block">
            <div className="absolute inset-0 bg-[#00ddb4]/20 blur-3xl rounded-full"></div>
            <img
              src="/produto-principal.jpeg"
              alt="Secaps Black — Produto"
              className="relative z-10 max-w-xs md:max-w-sm mx-auto rounded-2xl"
            />
          </div>
        </div>
      </section>
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            {[
              ...
              { icon: "🛡️", title: "Ingredientes Ativos", desc: "11 ativos de alta eficácia" },
            ].map((b) => (
